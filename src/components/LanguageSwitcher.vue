...
// القائمة النهائية والمنقحة للغات المدعومة
...
<template>
  <div class="relative">
    <select
      ...
      :value="locale"
      class="appearance-none bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white py-1.5 px-8 rounded-md text-sm cursor-pointer"
